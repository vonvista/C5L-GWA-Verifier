                ...
                <Dialog as="div" className="relative z-30" openModal={modalState} onClose={resetModalValues}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >   
                            ...
                            <Dialog.Panel className="w-full max-w-md 5xl:max-w-xl transform overflow-hidden rounded-2xl 5xl:round-3xl 5xl:py-8 bg-white py-6 px-7 text-left align-middle shadow-xl transition-all">
                                
                                {/* Window Title */}
                                <Dialog.Title
                                    as="h3"
                                    className="font-montserrat mt-[0.5vh] mb-2 text-2xl 5xl:text-4xl font-black leading-6 text-gray-900 flex"
                                >
                                    <span className="self-start">Justification</span>
                                    {/* Close button */}
                                    <XIcon
                                        className="w-5 5xl:w-7 cursor-pointer ml-auto mr-0 transition-all ease-out duration-200 hover:text-gray-500 hover:transition-all hover:ease-in hover:duration-200"
                                ...
                                {/* Window Body */}
                                <textarea
                                    className="font-inter mt-4 mb-3 mx-auto text-sm md:text-md lg:text-lg 5xl:text-2xl w-full h-[13vh] block resize-none focus:outline-none"
                                    name="desc"
                                ...
                                >
                                    <div className="flex w-full gap-1">
                                        <span className="flex-none font-poppins 5xl:text-lg font-medium py-1 px-2 block bg-sr-dark-gray rounded-lg text-sm text-gray-700 hover:bg-yellow-100 hover:text-secondary-red transition ease-in-out duration-300 hover:transition hover:ease-in hover:duration-300">
                                            Upload Image
                                        </span>

                                        <span // section that displays file name
                                            id="selectedFileName"
                                            className="font-inter inline truncate text-xs 5xl:text-lg self-center"
                                        >
                                            {imgName}
                                        </span>
                                    </div>
                                ...
                                <button
                                    type="submit"
                                    className="rounded-lg mt-3 w-1/5 inline-flex justify-center border border-transparent bg-button-green px-3 py-1.5 text-sm 5xl:text-xl lg:text-base font-poppins font-medium text-white
