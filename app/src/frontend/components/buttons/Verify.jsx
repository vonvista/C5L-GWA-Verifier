...
const Verify = ({ handleVerify, ...state }) => {
  const verifybtn = `w-full h-11 m-0 bg-login-green rounded-md text-white font-montserrat font-bold hover:shadow-lg hover:bg-login-green-hover disabled:bg-sr-disabled-green disabled:hover:shadow-none`;
