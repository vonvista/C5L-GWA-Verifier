...
export const LoginBtn = ({ handleClick, disabled }) => {
  const loginbtn = `w-6/12 h-11 1.75xl:text-lg bg-button-green rounded-lg text-white font-montserrat font-semibold transition ease-out duration-300 hover:transition hover:ease-in hover:duration-300 hover:shadow-lg hover:bg-button-green-hover
