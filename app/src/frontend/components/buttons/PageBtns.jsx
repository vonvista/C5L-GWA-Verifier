...
// This button components is used for navigation of pages in the list component
// --handleNext, handlePrev props: functions to handle click event

const PageBtns = ({ handleNext, handlePrev }) => {
  const img = `p-0.25 inline-flex`;
  return (
    <div className="grid-cols-2 divide-x w-40 p-2 ml-2 mr-0 inline-flex items-center justify-items-center rounded-lg border border-slate-300">
      <button
        type="button"
