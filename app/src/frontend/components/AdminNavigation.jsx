...
// Used for hover to be able trigger collapse/expansion of sidebar
const useHover = () => {
    ...
    return (
        ...
        >
            {/* <div className="flex place-content-center p-8"> */}
                {/* <div className={` ${ isHovering? "visible" : "hidden duration-10000" } flex-shrink-0  `}> */}
                {/* <div className={` ${ isHovering? "flex place-content-center" : "hidden" } py-8`}> */}
            ...
            {/* <div className="flex gap-x-4 items-center text-lg lg:text-base"> */}
                <img
                    className={` ${isHovering ? "ml-5 duration-500" : "ml-0 scale-50 duration-500" } rounded-full `}
                    // className={` ${isHovering ? "ml-5 duration-500" : "mt-16 ml-0 scale-50 duration-500" } rounded-full `}
                    // className={` ${isHovering ? "ml-5 duration-500" : "mt-16 ml-0 scale-50 duration-500" } rounded-full `}
                    width="85px"
                    height="85px"
                    alt="usericon"
            ...
            <div className="grid grid-cols-1 cursor-pointer text-xl">
                ...
                <div className={` ${isHovering? "mt-10" : "mt-2" } duration-300 flex gap-x-4 items-center p-2 hover:bg-secondary-red hover:text-highlight`}>
                    <div>
                        <svg className={` ${!isHovering && "ml-4"} duration-300 ml-5 fill-current`} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 36 36" >
                ...
                {/* User System */}
                <div className="relative inline-flex mt-3 items-center p-2 hover:bg-secondary-red hover:text-highlight">
                    <div>
                        <svg className={` ${!isHovering && "ml-3"} ml-4 fill-current duration-300`} xmlns="http://www.w3.org/2000/svg" width="35" height="30" viewBox="0 0 640 512">
                ...
                <div className="inline-flex mt-2 items-center p-2 hover:bg-secondary-red hover:text-highlight">
                    <div>
                        <svg className={` ${!isHovering && "ml-4"} ml-5 fill-current duration-300`} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
