...
function finalGwa() {
    ...
    var totalCumulative = testData.cumulative[testData.cumulative.length-1] / testData.totalunits; //divides the last object of the cumulative array to the total number of units
    var roundedCumulative = Math.round((totalCumulative + Number.EPSILON) * 100000) / 100000 //rounds the result to 4 decimal place 
        
    if (testData.gwa === roundedCumulative) { //checks if the gwa is equal to the cumulative 
        return <span>The GWA is correct.</span>
    }
